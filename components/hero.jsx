      ...
      <div className="flex lg:items-center justify-between lg:flex-row flex-col lg:gap-10 gap-6">
        ...
        >
          ...
          >
            <a
              href="#menu"
              className="inline-block px-6 lg:py-3 py-2 bg-[#763919] text-white font-semibold rounded-sm shadow-lg hover:scale-105 transition-transform"
            >
              Explore Menu
            </a>
            ...
            <a
              href="#order"
              className="inline-block px-6 lg:py-3 py-2 border-2 border-[#763919] text-[#763919] font-semibold rounded-sm hover:bg-yellow-50 hover:scale-105 transition-transform"
            >
              Order Now
            </a>
          </motion.div>
